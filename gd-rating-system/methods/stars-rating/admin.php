...
class gdrts_method_admin_stars_rating extends gdrts_method_admin {
	...
	public function panels( $panels ) {
		$panels['method_stars_rating'] = array(
			'title' => __( 'Stars Rating', 'gd-rating-system' ),
			'icon'  => 'star',
			'type'  => 'method',
	...
	public function _shared_settings( $prefix = '', $prekey = '', $method = '' ) {
		...
		return apply_filters( 'gdrts_shared_settings_stars-rating', array(
			'msr_rating'   => array(
				'name'     => __( 'Rating', 'gd-rating-system' ),
				'settings' => array(
			...
			'msr_style'    => array(
				...
				'settings' => array(
					new d4pSettingElement( $real_prefix, $this->key( 'template', $prekey ), __( 'Template', 'gd-rating-system' ), '', d4pSettingType::SELECT, $this->get( 'template' ), 'array', gdrts_admin_shared::data_list_templates( 'stars-rating' ) ),
			...
			'msr_color'    => array(
				'name'     => __( 'Font Icons Colors', 'gd-rating-system' ),
				'settings' => array(
