...
CREATE TABLE " . $tables['logs'] . " (
 ...
 item_id bigint(20) unsigned NOT NULL default '0' COMMENT 'from gdrts_items table',
 user_id bigint(20) unsigned NOT NULL default '0',
 ref_id bigint(20) unsigned NOT NULL default '0' COMMENT 'reference id for revotes from this same table',
