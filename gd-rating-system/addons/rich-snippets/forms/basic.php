...
<div class="gdrts-metabox-wrapper">
    <div class="gdrts-metabox-wrapper-left">
        <p>
			...
			<?php d4p_render_select( array_merge( array( 'default' => __( 'Default', 'gd-rating-system' ) ), gdrtsa_admin_rich_snippets()->get_list_embed_locations() ), array(
				'class'    => 'widefat',
				'selected' => $_gdrts_display,
				'name'     => 'gdrts[rich-snippets][display]'
			) ); ?>
        </p>
    </div>
    <div class="gdrts-metabox-wrapper-right">
        <p>
			...
			<?php d4p_render_select( array_merge( array( 'default' => __( 'Default', 'gd-rating-system' ) ), gdrtsa_admin_rich_snippets()->get_list_rating_methods() ), array(
				'class'    => 'widefat',
				'selected' => $_gdrts_rating_method,
				'name'     => 'gdrts[rich-snippets][rating_method]'
			) ); ?>
        </p>
    </div>
</div>
