...
<div class="gdrts-metabox-wrapper">
    <div class="gdrts-metabox-wrapper-left">
        <p>
			...
			<?php d4p_render_select( gdrtsa_admin_rich_snippets()->get_list_snippet_modes(), array(
				'class'    => 'widefat',
				'selected' => $_gdrts_mode,
				'name'     => 'gdrts[rich-snippets-mode][mode]',
				'id'       => 'gdrts-rich-snippets-modes-switch'
			) ); ?>
        </p>
    </div>
