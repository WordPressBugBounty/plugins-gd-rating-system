            ...
            <div class="__column-third __on-left">
                <p>
					...
					<?php d4p_render_select( gdrts_snippets_schema()->list_currencies(), array(
						...
						'name'     => 'gdrts[rich-snippets-mode][' . $_this->name . '][offers][' . $id . '][currency]',
						'id'       => 'gdrts-rich-snippets-mode-' . $_this->name . '-offers-' . $id . '-currency'
					) ); ?>
                </p>
            </div>
        ...
        <div class="gdrts-metabox-row __p-zero-margin __with-margin-bottom">
            ...
            <div class="__column-sixth __on-middle">
                <p>
					...
					<?php d4p_render_select( gdrts_snippets_schema()->list_conditions(), array(
						'class'    => 'widefat',
						'selected' => $data['condition'],
						'name'     => 'gdrts[rich-snippets-mode][' . $_this->name . '][offers][' . $id . '][condition]',
						'id'       => 'gdrts-rich-snippets-mode-' . $_this->name . '-offers-' . $id . '-condition'
					) ); ?>
                </p>
            </div>
            <div class="__column-sixth __on-middle">
                <p>
					...
					<?php d4p_render_select( gdrts_snippets_schema()->list_availabilities(), array(
						'class'    => 'widefat',
						'selected' => $data['availability'],
						'name'     => 'gdrts[rich-snippets-mode][' . $_this->name . '][offers][' . $id . '][availability]',
						'id'       => 'gdrts-rich-snippets-mode-' . $_this->name . '-offers-' . $id . '-availability'
					) ); ?>
                </p>
            </div>
            <div class="__column-third __on-right">
