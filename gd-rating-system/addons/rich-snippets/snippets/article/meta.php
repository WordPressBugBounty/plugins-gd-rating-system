...
<div class="gdrts-metabox-row __p-zero-margin __with-margin">
    <div class="__column-full">
        <p>
            <label for="gdrts-rich-snippets-mode-<?php echo $this->name; ?>-headline"><?php _e( 'Headline', 'gd-rating-system' ); ?>
                <strong>(<?php _e( 'required, maximum 110 characters', 'gd-rating-system' ); ?>)</strong></label>
