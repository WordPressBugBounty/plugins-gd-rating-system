...
<div class="gdrts-metabox-row __p-zero-margin __with-margin">
    ...
    <div class="__column-half __on-right">
        <p>
			...
			<?php d4p_render_select( array(
				'none'            => __( 'None', 'gd-rating-system' ),
				'offers'          => __( 'Offers', 'gd-rating-system' ),
				'aggregate_offer' => __( 'Aggregate Offer', 'gd-rating-system' )
			), array(
				'class'    => 'widefat gdrts-rich-snippets-mode-block-switch',
				'selected' => $this->data['offer'],
				'name'     => 'gdrts[rich-snippets-mode][' . $this->name . '][offer]',
				'id'       => 'gdrts-rich-snippets-mode-' . $this->name . '-offer'
			) ); ?>
        </p>
    </div>
</div>
...
<div class="gdrts-metabox-row __p-zero-margin __with-margin-bottom">
    ...
    <div class="__column-half __on-right">
        <p>
			...
			<?php d4p_render_select( $_list_of_categories, array(
				'class'    => 'widefat',
				'selected' => $this->data['category'],
				'name'     => 'gdrts[rich-snippets-mode][' . $this->name . '][category]',
				'id'       => 'gdrts-rich-snippets-mode-' . $this->name . '-category'
			) ); ?>
        </p>
    </div>
</div>
    ...
    <div class="gdrts-metabox-row __p-zero-margin __with-margin-bottom">
        <div class="__column-third __on-left">
            <p>
				...
				<?php d4p_render_select( gdrts_snippets_schema()->list_currencies(), array(
					'class'    => 'widefat',
					'selected' => $_aggregate_offer['currency'],
					'name'     => 'gdrts[rich-snippets-mode][' . $this->name . '][aggregate_offer][currency]',
					'id'       => 'gdrts-rich-snippets-mode-' . $this->name . '-aggregate_offer-currency'
				) ); ?>
            </p>
        </div>
