...
class gdrts_shortcode_builder_list {
	...
	public function init() {
		...
		if ( gdrts_is_method_loaded( 'stars-rating' ) ) {
			$this->register( 'gdrts_stars_rating', array(
				...
				'attrs'       => apply_filters( 'gdrts_shortcode_attrs_stars_rating',
			...
			$this->register( 'gdrts_stars_rating_auto', array(
				...
				'attrs'       => apply_filters( 'gdrts_shortcode_attrs_stars_rating_auto',
			...
			$this->register( 'gdrts_stars_rating_list', array(
				...
				'attrs'       => apply_filters( 'gdrts_shortcode_attrs_stars_rating_list',
		...
		if ( gdrts_is_method_loaded( 'like-this' ) ) {
			$this->register( 'gdrts_like_this', array(
				...
				'attrs'       => apply_filters( 'gdrts_shortcode_attrs_like_this',
					array_merge( $this->_atts_basic_attributes(),
			...
			$this->register( 'gdrts_like_this_auto', array(
				...
				'attrs'       => apply_filters( 'gdrts_shortcode_attrs_like_this_auto',
			...
			$this->register( 'gdrts_like_this_list', array(
				...
				'attrs'       => apply_filters( 'gdrts_shortcode_attrs_like_this_list',
					array_merge( $this->_atts_list_attributes( 'like-this' ),
		...
		$this->register( 'gdrts_rating_value', array(
			...
			'attrs'       => apply_filters( 'gdrts_shortcode_attrs_rating_value',
				array_merge( $this->_atts_basic_attributes(),
		...
		$this->register( 'gdrts_rating_value_auto', array(
			...
			'attrs'       => apply_filters( 'gdrts_shortcode_attrs_rating_value_auto',
		...
		$this->register( 'gdrts_has_voted', array(
			...
			'attrs'         => apply_filters( 'gdrts_shortcode_attrs_has_voted',
				array_merge( $this->_atts_basic_attributes(),
					$this->_atts_method_attributes(),
		...
		$this->register( 'gdrts_has_voted_auto', array(
			...
			'attrs'         => apply_filters( 'gdrts_shortcode_attrs_has_voted_auto',
				array_merge( $this->_atts_method_attributes(),
					$this->_atts_user_attributes(),
					$this->_atts_tag_attributes() ) )
		) );
		...
		$this->register( 'gdrts_has_not_voted', array(
			...
			'attrs'         => apply_filters( 'gdrts_shortcode_attrs_has_not_voted',
				array_merge( $this->_atts_basic_attributes(),
					$this->_atts_method_attributes(),
					$this->_atts_user_attributes(),
					$this->_atts_tag_attributes() ) )
		...
		$this->register( 'gdrts_has_not_voted_auto', array(
			...
			'attrs'         => apply_filters( 'gdrts_shortcode_attrs_has_not_voted_auto',
				array_merge( $this->_atts_method_attributes(),
					$this->_atts_user_attributes(),
					$this->_atts_tag_attributes() ) )
		) );
	...
	public function _atts_list_attributes( $method = 'stars-rating' ) {
		return array(
			array(
				'label'   => __( 'Rating object Entity and Type', 'gd-rating-system' ),
				'attr'    => 'type',
			...
			array(
				...
				'attr'    => 'orderby',
				'type'    => 'select',
				'options' => gdrts_admin_shared::data_list_orderby( $method ),
				'value'   => 'rating'
			),
			array(
	...
	private function _atts_like_this_method( $method = 'like-this' ) {
		return array(
			array(
				'label'   => __( 'Rating to Show', 'gd-rating-system' ),
				'attr'    => 'rating',
				'type'    => 'select',
				'options' => gdrts_admin_shared::data_list_rating_values( $method ),
				'value'   => 'sum'
			),
			array(
