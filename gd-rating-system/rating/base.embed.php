...
function _gdrts_helper_convert_boolean_string( $value ) : bool {
...
function _gdrts_helper_clean_call_method( $args ) : array {
	if ( ! empty( $args['style_type'] ) ) {
...
function _gdrts_embed_stars_rating( $atts ) {
	...
	$templates   = gdrts_admin_shared::data_list_templates( 'stars-rating' );

	$call_method['template'] = isset( $templates[ $call_method['template'] ] ) ? $call_method['template'] : array_key_first( $templates );
...
function _gdrts_embed_stars_rating_list( $atts ) {
	...
	$call_method = shortcode_atts( $defaults_method, $atts );
	$call_method = _gdrts_helper_clean_call_method( $call_method );
	$templates   = gdrts_admin_shared::data_list_templates( 'stars-rating', 'list' );
...
function _gdrts_embed_like_this( $atts ) {
	...
	$call_method = shortcode_atts( $defaults_method, $atts );
	$call_method = _gdrts_helper_clean_call_method( $call_method );
	$templates   = gdrts_admin_shared::data_list_templates( 'like-this' );
...
function _gdrts_embed_like_this_list( $atts ) {
	...
	$call_method = shortcode_atts( $defaults_method, $atts );
	$call_method = _gdrts_helper_clean_call_method( $call_method );
	$templates   = gdrts_admin_shared::data_list_templates( 'like-this', 'list' );
