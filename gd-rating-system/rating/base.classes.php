...
abstract class gdrts_method_series extends gdrts_method {
	...
	public function set_series( $object ) {
		$this->_current_series = $object;
	}
	...
	public function get_series_label( $name ) {
		$series = $this->get_series( $name );
	...
	public function default_series() {
		return '';
	}
	...
	public function modify_series( $args ) {
		$args['series'] = $this->_args['series'];
