...
?>
<div class="<?php echo esc_attr( d4p_sanitize_html_classes( join( ' ', $_classes ) ) ); ?>">
        ...
        <div class="d4p-content-right">
            <div class="d4p-update-info">
                ...
                if ( $_show_upgrade_db_button ) {
                    ...
                    <br/><br/>
                    <a class="button-primary" href="admin.php?page=gd-rating-system-about"><?php _e( 'Click here to continue', 'gd-rating-system' ); ?></a>
