...
<table class="no-margin">
    ...
    <tr>
        ...
        <td class="cell-three-right">
            <label for="<?php echo $this->get_field_id( 'votes_min' ); ?>"><?php _e( 'Minimum Votes', 'gd-rating-system' ); ?>:</label>
            <input class="widefat" id="<?php echo $this->get_field_id( 'votes_min' ); ?>" name="<?php echo $this->get_field_name( 'votes_min' ); ?>" type="number" min="0" step="1" value="<?php echo esc_attr( $instance['votes_min'] ); ?>"/>
        </td>
    </tr>
    </tbody>
</table>
