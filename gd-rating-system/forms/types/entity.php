...
?>
    ...
    <form method="post" action="">
        ...
        <div class="d4p-content-right">
			...
			$groups = array(
				'entity_basic' => array(
					'name'     => __( 'Entity', 'gd-rating-system' ),
					'settings' => array(
				...
				'entity_types' => array(
					'name'     => __( 'Types', 'gd-rating-system' ),
					'settings' => array(
						new d4pSettingElement( 'entity', 'types', __( 'Types', 'gd-rating-system' ), '', d4pSettingType::EXPANDABLE_PAIRS, $obj['types'], '', '', array(
							'label_key'           => __( 'Name', 'gd-rating-system' ),
							'label_value'         => __( 'Label', 'gd-rating-system' ),
							'label_button_add'    => __( 'Add New Type', 'gd-rating-system' ),
							'label_buttom_remove' => __( 'Remove', 'gd-rating-system' )
						) ),
					)
				)
			);
