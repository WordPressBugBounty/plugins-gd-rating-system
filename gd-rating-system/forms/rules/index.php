                ...
                <form method="post" action="">
                    ...
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <div class="d4p-setting-select">
									<?php gdrts_render_grouped_select( $items, array(
										'name'  => 'item',
										'class' => 'widefat'
									) ); ?>
                                </div>
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <div class="d4p-setting-select">
									<?php gdrts_render_grouped_select( $objects, array(
										'name'  => 'object',
										'class' => 'widefat'
									) ); ?>
                                </div>
								<?php foreach ( $groups as $_addon => $_methods ) {
									if ( $_methods === false ) {
                                        ...
                                        <div class="gdrts-addon-methods-group gdrts-addon-group-<?php echo $_addon; ?>" style="display: none">
											...
											if ( empty( $values ) ) {
												d4p_render_select( array( '0' => __( 'Supported methods not available', 'gd-rating-system' ) ), array(
													'selected' => '0',
													'name'     => $_addon . '[method]',
													'class'    => 'widefat'
												) );
											} else {
												d4p_render_select( $values, array(
													'name'  => $_addon . '[method]',
													'class' => 'widefat'
												) );
											}
