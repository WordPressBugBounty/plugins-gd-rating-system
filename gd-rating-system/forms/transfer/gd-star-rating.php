                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <div class="d4p-setting-number">
                                    ...
                                    <em><?php _e( 'Rating log might contain incomplete list of ratings compared to rating results, but these ratings include more information and can be edited or deleted later.', 'gd-rating-system' ); ?>
                                        <br/>
